...
static LOGGER_RUNNER: Logger = Logger::new("RUNNER", logger::LogLevel::Debug, Some("/var/log/griffon/griffon-daemon.log"));
static LOGGER_RUNNER_NETWORK: Logger = Logger::new("RUNNER-NETWORK", logger::LogLevel::Debug, Some("/var/log/griffon/griffon-daemon.log"));
